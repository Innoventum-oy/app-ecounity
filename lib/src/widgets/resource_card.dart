...
Widget resourceCard(BuildContext context, WebPage resource,bool isCompleted, int navIndex,{WebPageList? resources}) {
    ...
    child: ListTileTheme(
      ...
      child: ListTile(
        ...
        onTap: () async{
          ...
          AppRouter.navigate(context,resource.type.name, navIndex,replaceRoute:false,data:resource,pathways:resources,);
